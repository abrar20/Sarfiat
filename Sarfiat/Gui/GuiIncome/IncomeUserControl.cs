...
namespace Sarfiat.Gui.GuiIncome
{
    public partial class IncomeUserControl : UserControl
    {
                        ...
                        for (int i = 0; i < IdList.Count; i++)
                        {
                            ...
                            if (result == 1)
                            {
                                SystemRecords systemRecords = new SystemRecords
                                {
                                    ...
                                    Details = "تم حذف عملية القبض ذي الرقم التعريفي " + RowId.ToString(),
        ...
        //{public static IncomeUserControl Instance(int projectId)
        // return and if it is not created yet create it
        //{
        // return _IncomeUserControl ?? (new IncomeUserControl(projectId));
        // } }
        ...
        private void SetColumnsTitle()
        {
            ...
            dataGridView1.Columns[3].HeaderText = "تاريخ القبض";
        ...
        private DataTable SetDataTableColumns(DataTable dataTable)
        {
            ...
            dataTable.Columns["CustomerName"].SetOrdinal(2);
            dataTable.Columns["CustomerName"].ColumnName = "العميل";
            dataTable.Columns["IncomeDate"].SetOrdinal(3);
            dataTable.Columns["IncomeDate"].ColumnName = "تاريخ القبض";
