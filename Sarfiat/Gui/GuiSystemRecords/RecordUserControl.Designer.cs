...
namespace Sarfiat.Gui.GuiSystemRecords
{
    partial class RecordUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            buttonDelete.Location = new Point(1112, 10);
            ...
            buttonUpdate.Location = new Point(967, 10);
            ...
            buttonExport.Location = new Point(822, 10);
            ...
            Name = "RecordUserControl";
            RightToLeft = RightToLeft.Yes;
            Size = new Size(1262, 600);
            Leave += RecordUserControl_Leave;
