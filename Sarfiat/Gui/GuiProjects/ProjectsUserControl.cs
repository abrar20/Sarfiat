    ...
    public partial class ProjectsUserControl : UserControl
    {
        ...
        private async void buttonDelete_Click(object sender, EventArgs e)
        {
            if (dataGridView1.RowCount > 0)
            {
                ...
                if (Deleteresult)
                {
                    ...
                    {
                        MessageCollection.ShowRequirdDeleteRow();
                    }
                    loadingForm.Hide();
                }
        ...
        private void ProjectExplor()
        {
            if (dataGridView1.RowCount > 0)
            {
                ...
                ProjectManagementForm projectManagmentForm = new ProjectManagementForm(RowId);
        ...
        private void SetRoles()
        {
            ...
            if (!UsersRolesManager.GetRole("checkBoxExplore"))
            {
